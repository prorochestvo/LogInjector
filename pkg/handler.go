...
// CyclicOverwritingFilesHandler save messages to files by number.
// The file name is generated by fileNamePrefix and index.
// The folder is the directory where the files are saved.
// The maxFileCapacity is the maximum size of the file in bytes.
